...
public class App {
    public static void main(String[] args) {
        ...
        Player player3 = new Player("Azriel");
        Armor armor3 = new Armor("Baju", 4, 20);
        Weapon weapon3 = new Weapon("Busur", 50);
        player3.setArmor(armor3);
        player3.setWeapon(weapon3);

        Player player4 = new Player("Raihan");
        Armor armor4 = new Armor("Kaos", 2, 10);
        Weapon weapon4 = new Weapon("Ketapel", 30);
